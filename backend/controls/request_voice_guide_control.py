...
# Role: Prepares localized voice-guide text from medication details and rejects empty guide sources.
...
# Role:
# - Requests voice guide generation.
# Responsibilities:
# - Validate the speech language and reject empty medication guide text before returning it to the caller.
class RequestVoiceGuide:
    ...
    # Parameters:
    # - medication_detail (MedicationDetail): Medication detail entity used as guide source data.
    # - language (str): User setting language code.
    # Returns:
    ...
    # Description:
    # - Trims and lowercases the requested speech language, rejecting values outside ko and en.
    # Parameters:
    # - language (str): Requested Korean or English content language.
    # Returns:
    # - Supported language code, or HTTP 400 for an unsupported language.
