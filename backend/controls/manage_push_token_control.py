...
class ManagePushToken:
    ...
    # 함수이름: unregisterPushToken
    # 함수역할:
    # - 현재 인증 사용자와 일치하는 기기 토큰을 비활성화한다.
    # 매개변수:
    # - user_hash (str): 현재 인증 사용자의 식별 hash
    # - token (str): 비활성화할 기기 토큰
    # 반환값:
    # - 해제 요청 처리 결과
