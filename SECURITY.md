...
| --- | --- | --- |
| `v0.0.4-alpha` | Current alpha demo target | Security fixes should be applied here first. |
| `v0.0.3-alpha` | Superseded alpha demo | Update to `v0.0.4-alpha` unless a targeted backport is explicitly needed. |
